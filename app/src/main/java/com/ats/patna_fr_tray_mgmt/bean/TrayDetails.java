...
public class TrayDetails {
    ...
    public String getIntrayDate1() {
        return intrayDate1;
    }

    public void setIntrayDate1(String intrayDate1) {
    ...
    public String getIntrayDate2() {
        return intrayDate2;
    }

    public void setIntrayDate2(String intrayDate2) {
    ...
    public String toString() {
        return "TrayDetails{" +
                ...
                ", outtrayExtra=" + outtrayExtra +
                ", outtrayDate='" + outtrayDate + '\'' +
                ", intrayBig=" + intrayBig +
                ", intraySmall=" + intraySmall +
                ", intrayLead=" + intrayLead +
                ", intrayExtra=" + intrayExtra +
                ", intrayDate='" + intrayDate + '\'' +
                ", intrayBig1=" + intrayBig1 +
                ", intraySmall1=" + intraySmall1 +
                ", intrayLead1=" + intrayLead1 +
                ", intrayExtra1=" + intrayExtra1 +
                ", intrayDate1='" + intrayDate1 + '\'' +
                ", intrayBig2=" + intrayBig2 +
                ", intraySmall2=" + intraySmall2 +
                ", intrayLead2=" + intrayLead2 +
                ", intrayExtra2=" + intrayExtra2 +
                ", intrayDate2='" + intrayDate2 + '\'' +
